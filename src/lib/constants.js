...
export const RUNTIME_TYPES = {
  ...
  sel_api: {
    id: 'sel_api',
    label: 'SEL API Endpoint',
    short: 'SEL',
    color: '#5ec8f2',
    platformTool: 'sel',
    sourceLabel: 'SEL API Base URL',
    sourcePlaceholder: 'https://sel.enterprise.com/api/v1',
    entryLabel: 'SEL Agent ID',
    entryPlaceholder: 'agent-arch-review-prod',
    healthPlaceholder: 'https://sel.enterprise.com/api/v1/health',
    invokeLabel: 'SEL Invoke Path',
    invokePlaceholder: '/agents/invoke',
  },
  ignio_api: {
    id: 'ignio_api',
    label: 'Ignio Agent Endpoint',
    short: 'Ignio',
    color: '#9b8bd4',
    platformTool: 'ignio',
    sourceLabel: 'Ignio Workspace URL',
    sourcePlaceholder: 'https://ignio.company.com/workspace/ams-prod',
    entryLabel: 'Ignio Flow / Agent Name',
    entryPlaceholder: 'rca-automation-flow',
    healthPlaceholder: 'https://ignio.company.com/api/health',
    invokeLabel: 'Ignio Trigger Endpoint',
    invokePlaceholder: '/flows/execute',
  },
  are_api: {
    id: 'are_api',
    label: 'ARE AIOps Endpoint',
    short: 'ARE',
    color: '#e8b84a',
    platformTool: 'are',
    sourceLabel: 'ARE Tenant Base URL',
    sourcePlaceholder: 'https://are.aiops.company.com/v1',
    entryLabel: 'ARE Playbook / Agent ID',
    entryPlaceholder: 'remediation-playbook-42',
    healthPlaceholder: 'https://are.aiops.company.com/v1/status',
    invokeLabel: 'ARE Invoke Path',
    invokePlaceholder: '/playbooks/run',
  },
}
